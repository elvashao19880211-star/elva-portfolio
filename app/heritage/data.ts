...
const heritageData: HeritageItem[] = [
  {
    ...
    dynasty: '唐',
    category: '瑞兽纹',
    coverSrc: '/images/revival/唐代-对鹿联珠团窠.png',
    videoUrl: '',
    videoTitle: '',
    ...
    processSteps: [
      {
        ...
        imageSrc: '/images/revival/唐代-对鹿联珠团窠.png',
      },
      {
        name: '文物对照',
    ...
    finalImage: '/images/revival/唐代-对鹿联珠团窠.png',
  ...
  },
  {
    ...
    dynasty: '汉',
    category: '云气纹',
    coverSrc: '/images/revival/汉代-大宜子孙安乐锦纹.png',
    videoUrl: '',
    videoTitle: '',
    ...
    processSteps: [
      {
        ...
        imageSrc: '/images/revival/汉代-大宜子孙安乐锦纹.png',
      },
      {
        name: '文物对照',
    ...
    finalImage: '/images/revival/汉代-大宜子孙安乐锦纹.png',
  ...
  },
  {
    ...
    dynasty: '清',
    category: '吉祥纹',
    coverSrc: '/images/revival/清代-云蝠纹.png',
    videoUrl: '',
    videoTitle: '',
    ...
    processSteps: [
      {
        ...
        imageSrc: '/images/revival/清代-云蝠纹.png',
      },
      {
        name: '文物对照',
    ...
    finalImage: '/images/revival/清代-云蝠纹.png',
