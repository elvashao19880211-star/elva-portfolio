...
const heritageData: HeritageItem[] = [
  {
    ...
    dynasty: '唐',
    category: '瑞兽纹',
    coverSrc: '/images/revival/唐代-对鹿联珠团窠.webp',
    videoUrl: '',
    videoTitle: '',
    ...
    processSteps: [
      {
        ...
        imageSrc: '/images/revival/唐代-对鹿联珠团窠.webp',
      },
      {
        name: '文物对照',
    ...
    finalImage: '/images/revival/唐代-对鹿联珠团窠.webp',
  ...
  },
  {
    ...
    dynasty: '汉',
    category: '云气纹',
    coverSrc: '/images/revival/汉代-大宜子孙安乐锦纹.webp',
    videoUrl: '',
    videoTitle: '',
    ...
    processSteps: [
      {
        ...
        imageSrc: '/images/revival/汉代-大宜子孙安乐锦纹.webp',
      },
      {
        name: '文物对照',
    ...
    finalImage: '/images/revival/汉代-大宜子孙安乐锦纹.webp',
  ...
  },
  {
    ...
    dynasty: '清',
    category: '吉祥纹',
    coverSrc: '/images/revival/清代-云蝠纹.webp',
    videoUrl: '',
    videoTitle: '',
    ...
    processSteps: [
      {
        ...
        imageSrc: '/images/revival/清代-云蝠纹.webp',
      },
      {
        name: '文物对照',
    ...
    finalImage: '/images/revival/清代-云蝠纹.webp',
